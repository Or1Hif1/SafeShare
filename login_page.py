...
class LoginPage:
    def __init__(self, screen):
        ...
        self.sbg = pygame.image.load("images/Singupbackground.png")
    ...
    def signup(self):
        ...
        self.screen.blit(pygame.image.load("images/i have an account.png"), (1042, 658))
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:
                if event.button == 1 and not self.is_submit:  # Left click (button 1 is left click)
                    ...
                    if mouse_x > 1013 and mouse_y > 658:
    ...
    def login(self):
        ...
        if self.opacity > 1:
            ...
            self.screen.blit(pygame.image.load("images/i dont have account.png"), (1013, 658))
